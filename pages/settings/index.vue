    ...
    <div class="body">
      ...
      >
        <span slot="begin_date" slot-scope="text">
          <span class="flex gap-5 justify-end cursor-pointer">
           {{ text }} <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M9.61914 3.95312L13.6658 7.99979L9.61914 12.0465" stroke="#092D53" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M2.33398 8H13.554" stroke="#092D53" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
